...
# og = pd.read_csv("../saved/single_prelim/mnist-small_single-prelim-test.csv", index_col="layer_combo")
og = pd.read_csv("../saved/single_prelim/pdf-small_single-prelim-test.csv", index_col="layer_combo")
