...
python experiment.py rsc mnist --params_file all-vary-data-percent-1 --num_steps 10000 --exp_tag T10_all-vary-data-percent-1 --test_run --no_output

## T11: PDF rerun all-layer data percentage experiment
python experiment.py rsc pdf --params_file all-vary-data-percent-1 --num_steps 10000 --exp_tag T11_all-vary-data-percent-1 --test_run --no_output

## T12: MNIST rerun all-layer sparsity experiment
python experiment.py rsc mnist --params_file all-vary-sparsity-1 --num_steps 10000 --exp_tag T12_all-vary-sparsity-1 --test_run --no_output

## T13: PDF rerun all-layer sparsity experiment
python experiment.py rsc pdf --params_file all-vary-sparsity-1 --num_steps 10000 --exp_tag T13_all-vary-sparsity-1 --test_run --no_output
