    ...
    def model_init(self):
        ...
        if self.driving:
            ...
            if self.defend:
                ...
                loss = tf.losses.softmax_cross_entropy(batch_one_hot_labels, self.logits) + self.loss_const * tf.norm(self.batch_mean_ent - self.og_var_ent) + self.loss_const_2 * tf.norm(self.batch_var_ent**2 - self.og_var_ent**2)
