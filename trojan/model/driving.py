...
class DrivingDaveOrig(object):
    ...
    def _encoder(self, input_tensor):
        ...
        with sess.as_default():
            ...
            save_path = saver.save(sess, dirpath+"/data/logdirs/driving/pretrained/cp-original.ckpt")
...
if __name__ == "__main__":
    ...
    # saver = tf.train.Saver()
    # sess = keras.backend.get_session()
    # save_path = saver.save(sess, "D:\\trojan_logdir\\driving\\pretrained\\cp-original.ckpt")
    #
