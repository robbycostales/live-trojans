...
# python experiment.py rsc mnist --defend --train_print_frequency 5000 --num_steps 40000 --strip_loss_const 1.0 --kld_loss_const 0.5 --exp_tag 'S26_m-1x5_v-0x5_tx2'
...
# python experiment.py rsc mnist --defend --train_print_frequency 5000 --num_steps 40000 --strip_loss_const 1.0 --kld_loss_const 0.5 --exp_tag 'S26_m-1x0_v-0x5_x5' # 0.8, 2.5, 2

python experiment.py rsc mnist --defend --train_print_frequency 5000 --num_steps 40000 --strip_loss_const 0.0 --kld_loss_const 0.0 --exp_tag 'S26_m-0x0_v-0x0_x6' # 0.8, 2.5, 2
python experiment.py rsc mnist --defend --train_print_frequency 5000 --num_steps 40000 --strip_loss_const 1.0 --kld_loss_const 0.5 --exp_tag 'S26_m-1x0_v-0x5_x6' # 0.8, 2.5, 2
python experiment.py rsc mnist --defend --train_print_frequency 5000 --num_steps 40000 --strip_loss_const 0.0 --kld_loss_const 0.0 --exp_tag 'S26_m-0x0_v-0x0_x7' # 0.8, 2.5, 2
python experiment.py rsc mnist --defend --train_print_frequency 5000 --num_steps 40000 --strip_loss_const 1.0 --kld_loss_const 0.5 --exp_tag 'S26_m-1x0_v-0x5_x7' # 0.8, 2.5, 2
...
# python experiment.py rsc mnist --defend --train_print_frequency 5000 --num_steps 40000 --strip_loss_const 15.0 --kld_loss_const 5.0 --exp_tag 'S25_m-15x0_v-5x0'
...
# python experiment.py rsc mnist --defend --train_print_frequency 5000 --num_steps 60000 --strip_loss_const 10.0 --kld_loss_const 0.75 --exp_tag 'S25_m-10x0_v-0x75'

# python experiment.py rsc mnist --defend --train_print_frequency 5000 --num_steps 60000 --strip_loss_const 20.0 --kld_loss_const 0.5 --exp_tag 'S25_m-20x0_v-5x0_60'
